...
// Featured dishes data - add video property for food prep videos
const featuredDishes = [
  {
    name: 'LAMB NIHARI',
    description: 'Slow-cooked lamb in a rich, aromatic gravy, simmered to tender perfection with traditional spices.',
    image: 'https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=800&h=600&fit=crop', // Rich curry/stew placeholder
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?w=800&h=600&fit=crop', // Rice/Biryani placeholder
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1625938145744-e38051539994?w=800&h=600&fit=crop', // Fried food placeholder
    ...
    <>
      ...
      <section className="relative h-screen w-full overflow-hidden flex items-end justify-center">
        ...
        <div className="absolute inset-0 z-0 bg-black overflow-hidden">
          {/* Blurred Background for Desktop (fills empty space smoothly) */}
          <video
            autoPlay
            muted
            loop
        ...
        {/* Falling Spices Effect - Desktop Only */}
        <div className="hidden md:block absolute inset-0 pointer-events-none z-10">
          <FallingSpices />
        </div>

        {/* Hero Content - Centered buttons at the bottom */}
